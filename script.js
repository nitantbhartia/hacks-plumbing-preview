...
const I18N = {
  en: {
    ...
    lede: "Hack’s Plumbing & Drain is a family-owned team serving homeowners and businesses across San Diego County. Licensed and insured. Upfront pricing. No hidden fees. 100% satisfaction language is on the original site. Emergency plumbing support is listed as 24/7 on that homepage; shop hours on the Terms page are below.",
    ck1: "Grease trap",
    ck2: "Hydro jet",
    ck3: "Camera",
    ck4: "Gas line",
    ...
    crewT: "Named on the quotes",
    crewNote: "Quotes as printed on the original site. Not rewritten.",
    hoursT: "Hours (Terms of Service)",
    hoursB: "Monday – Friday, 7:00 AM – 7:00 PM; Saturday, 7:00 AM – 5:00 PM (Pacific Time). The homepage also lists 24/7 emergency plumbing support. Serving San Diego County, CA.",
  ...
  es: {
    ...
    lede: "Hack’s Plumbing & Drain es un equipo familiar que atiende casas y negocios en el Condado de San Diego. Con licencia y asegurados. Precio por adelantado. Sin cargos ocultos. El sitio original habla de 100% de satisfacción. El inicio lista apoyo de plomería de emergencia 24/7; el horario del taller en Términos está abajo.",
    ck1: "Trampa de grasa",
    ck2: "Hidrojet",
    ck3: "Cámara",
    ck4: "Línea de gas",
    ...
    more: "También en el sitio original: llaves que gotean, drenajes tapados, instalación de calentador, emergencias, detección de fugas, alcantarilla y gas, repipes, inodoros, válvulas de ducha, trituradores, localización de fosa. Presupuestos sin compromiso. Una llamada para reparaciones, instalaciones, drenaje, gas, hidrojet y emergencias.",
    jobsT: "Trabajos nombrados en el sitio",
    ...
    crewT: "Nombres en las citas",
    crewNote: "Citas tal como están en el sitio original. Sin reescribir.",
    hoursT: "Horario (Términos de servicio)",
    hoursB: "Lunes a viernes, 7:00 a.m. – 7:00 p.m.; sábado, 7:00 a.m. – 5:00 p.m. (hora del Pacífico). El inicio también lista apoyo de emergencia 24/7. Sirve el Condado de San Diego, CA.",
